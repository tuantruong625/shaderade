...
export default function App() {
 ...
 return (
  <div className="container mx-auto max-w-6xl m-5 text-gray-800">
   ...
   <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
    <div className="col-span-full">
     <label htmlFor="color" className="flex flex-col md:w-1/4 w-100 pb-5">
      Enter color
      <input type="text" name="color" placeholder="#e2e2e2" className="p-2 border" onChange={onChange} />
      <input type="color" name="color" value={color}  className="p-2 border" onChange={onChange} />
     </label>
    </div>
